		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori Report",
									"targetURL": "#brcomclientegestaofiorireport278-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"brcomclientegestaofiorireport278-display": {
								"semanticObject": "brcomclientegestaofiorireport278",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=br.com.cliente.gestao.fiorireport278",
									"url": sap.ui.require.toUrl("br/com/cliente/gestao/fiorireport278")
								}
							}
						}
					}
