		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#brcomfiltersfilters-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"brcomfiltersfilters-display": {
								"semanticObject": "brcomfiltersfilters",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=br.com.filters.filters",
									"url": sap.ui.require.toUrl("br/com/filters/filters")
								}
							}
						}
					}
